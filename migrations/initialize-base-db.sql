...
CREATE TABLE `lendings` (
  ...
  KEY `FK_LEND_TRANSACTION_idx` (`lend_trans_id`),
  KEY `FK_LEND_USER_TRANSACTION_idx` (`lend_user_id`,`lend_trans_id`),
  CONSTRAINT `FK_LEND_TRANSACTION` FOREIGN KEY (`lend_trans_id`) REFERENCES `transactions` (`trans_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `FK_LEND_USER` FOREIGN KEY (`lend_user_id`) REFERENCES `users` (`user_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `FK_LEND_USER_TRANSACTION` FOREIGN KEY (`lend_user_id`, `lend_trans_id`) REFERENCES `transactions` (`trans_user_id`, `trans_id`)
...
INSERT INTO `transactions` VALUES (1,8,NULL,NULL,'Testing transaction','Testing transaction','Mobile','INR','CREDIT',1000.000,'UPI','2023-02-14 00:00:00',0,'2023-02-13 19:39:49','2023-02-13 19:39:49'),(2,8,NULL,NULL,'Testing transaction','Testing transaction','Mobile','INR','CREDIT',1000.000,'UPI','2023-02-14 00:00:00',0,'2023-02-13 19:40:21','2023-02-13 19:40:21');
...
-- Dump completed on 2023-02-14  1:46:37
